---
title: "Statistical Interference Course Project 1"
...
output:
  ...
  pdf_document:
    toc: yes
    toc_depth: '6'
subtitle: A study around the exponential distribution in R and its comparison with
...
```{r DataCreation21, echo=TRUE, fig.height=7, fig.width=7}
mns = NULL
...
```{r DataCreation24, echo=TRUE, fig.height=7, fig.width=7}
mns = NULL
...
```{r ggplot, echo=TRUE, fig.height=7, fig.width=7}
...
```{r Q-Q, echo=TRUE, fig.height=7, fig.width=7 }
